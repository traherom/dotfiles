local function find_command()
  if 1 == vim.fn.executable("rg") then
    return {
      ...
      "!.git",
      -- "-g",
      -- "!components/benchmarks/benchmarks",
      "-g",
      "!__corelink",
    }
  ...
  return {
    defaults = {
      ...
      vimgrep_arguments = {
        ...
        "--smart-case",
        "--glob=!.git",
        "--glob=!components/benchmarks/benchmarks",
      },
    },
    pickers = {
      find_files = {
...
return {
  {
    ...
    keys = function()
      return {
        ...
        { "<leader>/", "<cmd>Telescope live_grep", desc = "Grep (cwd)" },
        { "<leader>:", "<cmd>Telescope command_history<cr>", desc = "Command History" },
        { "<leader><space>", "<cmd>Telescope find_files<cr>", desc = "Recent" },
        -- find
